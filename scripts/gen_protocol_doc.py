...
def generate() -> str:
    ...
    agent_run_req_example = {
        ...
        "params": {
            ...
            "workspace_root": "D:/git/KamaClaude",
        },
    }
    ...
    sections = [
        ...
        "\n",
        _model_section("AgentListRunsCommand", AgentListRunsCommand),
        "\n",
        _model_section("AgentListRunsResult", AgentListRunsResult),
        "\n",
        _model_section("AgentCancelCommand", AgentCancelCommand),
        "\n",
        _model_section("AgentCancelResult", AgentCancelResult),
        "\n",
        _model_section("AgentSnoozeCommand", AgentSnoozeCommand),
        "\n",
        _model_section("AgentSnoozeResult", AgentSnoozeResult),
        "\n",
        ...
        "\n",
        _model_section("SessionBranchCommand", SessionBranchCommand),
        "\n",
        _model_section("SessionBranchResult", SessionBranchResult),
        "\n",
        _model_section(
        ...
        "| -32010 | Session Not Found | Unknown Session ID |\n",
        "| -32011 | Session Closed | Session cannot accept the requested operation |\n",
        "| -32012 | Session Busy | Session already has a running request |\n",
        "| -32013 | Workspace Mismatch | Session belongs to another workspace |\n",
        "| -32014 | Branch Unavailable | Exact code state cannot be reconstructed |\n",
    ]
