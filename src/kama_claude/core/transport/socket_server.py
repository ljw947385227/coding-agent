...
class SocketServer:
    ...
    async def stop(self) -> None:
        ...
        try:
            ...
            pass
        await self._cancel_tasks(self._request_tasks, "request")
        await self._cancel_tasks(self._connection_tasks, "connection")
        self._server = None
    ...
    async def _cancel_tasks(
        ...
        if pending:
            logger.warning("shutdown: %d socket %s task(s) still pending", len(pending), kind)
