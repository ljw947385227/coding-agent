...
```json
{
  "properties": {
    "type": {
      "const": "agent.list_runs",
      "default": "agent.list_runs",
      "title": "Type",
      "type": "string"
    },
    "workspace_root": {
...
| `idle_seconds` | `number` | yes |
| `current_phase` | `string` | yes |
| `current_tool` | `string | null` | no |
| `ts` | `string` | yes |
...
```json
{
  "properties": {
    "type": {
      "const": "run.attention_required",
      "default": "run.attention_required",
      "title": "Type",
      "type": "string"
    },
    "run_id": {
  ...
  "title": "RunAttentionRequiredEvent",
  "type": "object"
}
```
